/*
	Dennisse Pagan Davila - Portfolio [Games Page]
...
(function($) {
	...
	$(
		...
		// $('#nav').navList() +
		'<a class="link depth-0" href="index.html"><span class="indent-0"></span><i class="fas fa-home" aria-hidden="true"></i> Home</a>' +
		...
		'<a class="link depth-0" href="#top"><span class="indent-0"></span><i class="fas fa-gamepad" aria-hidden="true"></i> 2D Space Shooter</a>' +
